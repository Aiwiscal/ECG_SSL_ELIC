...
class VGG16(nn.Module):
    def __init__(self, ch_in=8, n_classes=1000, alpha=0.5):
        ...
        self.model = nn.Sequential(
            ...
            vgg_conv_block([128*alpha, 256*alpha, 256*alpha], [256*alpha, 256*alpha, 256*alpha], [3, 3, 3], [1, 1, 1], 2, 2),
            vgg_conv_block([256*alpha, 512*alpha, 512*alpha], [512*alpha, 512*alpha, 512*alpha], [3, 3, 3], [1, 1, 1], 2, 2),
            vgg_conv_block([512*alpha, 512*alpha, 512*alpha], [512*alpha, 512*alpha, 512*alpha], [3, 3, 3], [1, 1, 1], 2, 2),
